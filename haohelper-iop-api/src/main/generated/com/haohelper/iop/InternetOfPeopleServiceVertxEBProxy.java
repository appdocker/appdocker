...
public class InternetOfPeopleServiceVertxEBProxy implements InternetOfPeopleService {
  ...
  public InternetOfPeopleServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public InternetOfPeopleServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
